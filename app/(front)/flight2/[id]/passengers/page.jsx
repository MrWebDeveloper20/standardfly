...
const Flight = (params) => {
  ...
  const MNum2Url = searchParams.get('MNum2')
  ...
  const [MNum2, setMNum2] = useState(MNum2Url)
  ...
  const setADayM = (event) => {
    console.log('testdayM', event.target.id, event.target.value)
    switch (event.target.id) {
      case 'dayM1':
  ...
  const [passcount1, setAdultpasscount1] = useState()
  const [passcount2, setAdultpasscount2] = useState()
  const [passcount3, setAdultpasscount3] = useState()
  const [passcount4, setAdultpasscount4] = useState()
  const [passcount5, setAdultpasscount5] = useState()
  const [passcount6, setAdultpasscount6] = useState()
  const [passcount7, setAdultpasscount7] = useState()
  const [passcount8, setAdultpasscount8] = useState()
  const [passcount9, setAdultpasscount9] = useState()

  const setApasscount = (event) => {
    // console.log('test',event.target.id, event.target.value)
    switch (event.target.id) {
      case 'passcount1':
        setAdultpasscount1(event.target.value)
        break
      case 'passcount2':
        setAdultpasscount2(event.target.value)
        break
      case 'passcount3':
        setAdultpasscount3(event.target.value)
        break
      case 'passcount4':
        setAdultpasscount4(event.target.value)
        break
      case 'passcount5':
        setAdultpasscount5(event.target.value)
        break
      case 'passcount6':
        setAdultpasscount6(event.target.value)
        break
      case 'passcount7':
        setAdultpasscount7(event.target.value)
        break
      case 'passcount8':
        setAdultpasscount8(event.target.value)
        break
      case 'passcount9':
        setAdultpasscount9(event.target.value)
        break
      default:
        break
    }
  ...
  const [passNum1, setAdultpassNum1] = useState()
  const [passNum2, setAdultpassNum2] = useState()
  const [passNum3, setAdultpassNum3] = useState()
  const [passNum4, setAdultpassNum4] = useState()
  const [passNum5, setAdultpassNum5] = useState()
  const [passNum6, setAdultpassNum6] = useState()
  const [passNum7, setAdultpassNum7] = useState()
  const [passNum8, setAdultpassNum8] = useState()
  const [passNum9, setAdultpassNum9] = useState()

  const setApassNum = (event) => {
    // console.log('test',event.target.id, event.target.value)
    switch (event.target.id) {
      case 'passNum1':
        setAdultpassNum1(event.target.value)
        break
      case 'passNum2':
        setAdultpassNum2(event.target.value)
        break
      case 'passNum3':
        setAdultpassNum3(event.target.value)
        break
      case 'passNum4':
        setAdultpassNum4(event.target.value)
        break
      case 'passNum5':
        setAdultpassNum5(event.target.value)
        break
      case 'passNum6':
        setAdultpassNum6(event.target.value)
        break
      case 'passNum7':
        setAdultpassNum7(event.target.value)
        break
      case 'passNum8':
        setAdultpassNum8(event.target.value)
        break
      case 'passNum9':
        setAdultpassNum9(event.target.value)
        break
      default:
        break
    }
  ...
  const [dayEXP1, setAdultDayEXP1] = useState()
  const [dayEXP2, setAdultDayEXP2] = useState()
  const [dayEXP3, setAdultDayEXP3] = useState()
  const [dayEXP4, setAdultDayEXP4] = useState()
  const [dayEXP5, setAdultDayEXP5] = useState()
  const [dayEXP6, setAdultDayEXP6] = useState()
  const [dayEXP7, setAdultDayEXP7] = useState()
  const [dayEXP8, setAdultDayEXP8] = useState()
  const [dayEXP9, setAdultDayEXP9] = useState()

  const setADayEXP = (event) => {
    // console.log('test',event.target.id, event.target.value)
    switch (event.target.id) {
      case 'dayEXP1':
        setAdultDayEXP1(event.target.value)
        break
      case 'dayEXP2':
        setAdultDayEXP2(event.target.value)
        break
      case 'dayEXP3':
        setAdultDayEXP3(event.target.value)
        break
      case 'dayEXP4':
        setAdultDayEXP4(event.target.value)
        break
      case 'dayEXP5':
        setAdultDayEXP5(event.target.value)
        break
      case 'dayEXP6':
        setAdultDayEXP6(event.target.value)
        break
      case 'dayEXP7':
        setAdultDayEXP7(event.target.value)
        break
      case 'dayEXP8':
        setAdultDayEXP8(event.target.value)
        break
      case 'dayEXP9':
        setAdultDayEXP9(event.target.value)
        break
      default:
        break
    }
  ...
  const [monthEXP1, setAdultmonthEXP1] = useState()
  const [monthEXP2, setAdultmonthEXP2] = useState()
  const [monthEXP3, setAdultmonthEXP3] = useState()
  const [monthEXP4, setAdultmonthEXP4] = useState()
  const [monthEXP5, setAdultmonthEXP5] = useState()
  const [monthEXP6, setAdultmonthEXP6] = useState()
  const [monthEXP7, setAdultmonthEXP7] = useState()
  const [monthEXP8, setAdultmonthEXP8] = useState()
  const [monthEXP9, setAdultmonthEXP9] = useState()

  const setAMonthEXP = (event) => {
    // console.log('test',event.target.id, event.target.value)
    switch (event.target.id) {
      case 'monthEXP1':
        setAdultmonthEXP1(event.target.value)
        break
      case 'monthEXP2':
        setAdultmonthEXP2(event.target.value)
        break
      case 'monthEXP3':
        setAdultmonthEXP3(event.target.value)
        break
      case 'monthEXP4':
        setAdultmonthEXP4(event.target.value)
        break
      case 'monthEXP5':
        setAdultmonthEXP5(event.target.value)
        break
      case 'monthEXP6':
        setAdultmonthEXP6(event.target.value)
        break
      case 'monthEXP7':
        setAdultmonthEXP7(event.target.value)
        break
      case 'monthEXP8':
        setAdultmonthEXP8(event.target.value)
        break
      case 'monthEXP9':
        setAdultmonthEXP9(event.target.value)
        break
      default:
        break
    }
  ...
  const [yearEXP1, setAdultyearEXP1] = useState()
  const [yearEXP2, setAdultyearEXP2] = useState()
  const [yearEXP3, setAdultyearEXP3] = useState()
  const [yearEXP4, setAdultyearEXP4] = useState()
  const [yearEXP5, setAdultyearEXP5] = useState()
  const [yearEXP6, setAdultyearEXP6] = useState()
  const [yearEXP7, setAdultyearEXP7] = useState()
  const [yearEXP8, setAdultyearEXP8] = useState()
  const [yearEXP9, setAdultyearEXP9] = useState()

  const setAYearEXP = (event) => {
    // console.log('test',event.target.id, event.target.value)
    switch (event.target.id) {
      case 'yearEXP1':
        setAdultyearEXP1(event.target.value)
        break
      case 'yearEXP2':
        setAdultyearEXP2(event.target.value)
        break
      case 'yearEXP3':
        setAdultyearEXP3(event.target.value)
        break
      case 'yearEXP4':
        setAdultyearEXP4(event.target.value)
        break
      case 'yearEXP5':
        setAdultyearEXP5(event.target.value)
        break
      case 'yearEXP6':
        setAdultyearEXP6(event.target.value)
        break
      case 'yearEXP7':
        setAdultyearEXP7(event.target.value)
        break
      case 'yearEXP8':
        setAdultyearEXP8(event.target.value)
        break
      case 'yearEXP9':
        setAdultyearEXP9(event.target.value)
        break
      default:
        break
    }
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center mt-3">
      <div className="contain flex flex-col gap-5 lg:w-3/5 h-fit mb-10">
        <div className="flightInfoG flex flex-row-reverse w-full h-40 rounded-lg bg-gray-200">
          <div className="infoRight flex flex-row-reverse w-3/4 h-40">
            ...
            <div className="info flex flex-col items-center justify-between my-2 w-2/3">
              <h2 className="alib text-green-500">پرواز رفت</h2>
              ...
              <div className="Time flex flex-row-reverse justify-center items-center">
                <div className="az alir text-green-500">{fromname}</div>
                <div className="khat w-10 h-1 mx-3 bg-gray-800"></div>
                <div className="be alir text-green-500">{toname}</div>
              </div>
            </div>
          </div>
          <div className="infoRight flex flex-col justify-around items-center w-1/4 h-40 shadow-sm shadow-black rounded-l-lg">
            ...
            <div className="price flex flex-row">
              ...
              <h2 className="alib">قیمت بلیط رفت</h2>
            </div>
          </div>
        </div>
        ...
        <div className="flightInfoG flex flex-row-reverse w-full h-40 rounded-lg bg-gray-200">
          <div className="infoRight flex flex-row-reverse w-3/4 h-40">
            ...
            <div className="info flex flex-col items-center justify-between my-2 w-2/3">
              <h2 className="alib text-blue-700">پرواز برگشت</h2>
              <div className="date flex flex-row-reverse">
                <span className="alib">{day2}</span>
                <span className="alib mx-3">{MName2}</span>
                <span className="alib">{year2}</span>
              </div>
              <div className="systemy flex flex-row-reverse gap-3">
                <span className="alib">سیستمی</span>
                <span className="alib">اکونومی</span>
              ...
              <div className="Time flex flex-row justify-center items-center">
                <div className="az alir text-blue-700">{fromname}</div>
                <div className="khat w-10 h-1 mx-3 bg-gray-800"></div>
                <div className="be alir text-blue-700">{toname}</div>
              </div>
            </div>
          </div>
          <div className="infoRight flex flex-col justify-around items-center w-1/4 h-40 shadow-sm shadow-black rounded-l-lg">
            ...
            <div className="price flex flex-row">
              ...
              <h2 className="alib">قیمت بلیط برگشت</h2>
            </div>
          </div>
        </div>

        <form
          action={`/flight2/final${flightNoG}&${flightNoR}/sale`}
        ...
        >
          <div className="passProp flex flex-col gap-3">
                        ...
                        {passC && (
                          <div className="butt flex lg:flex-row-reverse gap-2 lg:justify-start">
                            ...
                            <input
                              ...
                              className="alib w-1/4 p-2 rounded-lg text-right"
                              type="text"
                              name={`passcount${Number(s) + Number(adult)}`}
                              id={`passcount${Number(s) + Number(adult)}`}
                              placeholder="کشور صادر کننده پاسپورت "
                            />
                            ...
                            <input
                              ...
                              className="alib w-1/4 p-2 rounded-lg text-right"
                              type="text"
                              name={`passNum${Number(s) + Number(adult)}`}
                              id={`passNum${Number(s) + Number(adult)}`}
                              placeholder="شماره پاسپورت "
                            />
                            <div className="alib datee flex flex-col m-0 w-1/4 p-0 rounded-lg text-right">
                              <span className="alib text-xs">
            ...
            <input type="hidden" name="flightNoG" value={flightNoG} />
            <input type="hidden" name="flightNoR" value={flightNoR} />
            ...
            <input type="hidden" name="dateG" value={dateG} />
            <input type="hidden" name="dateR" value={dateR} />
            <input type="hidden" name="time" value={time} />
            <input type="hidden" name="timeD" value={timeD} />
          </div>
          <div className="submit flex flex-col mt-2">
            <div className="price flex flex-col">
              <h2 className="alib">: مجموع قیمت رفت و برگشت </h2>
              <div className="price flex flex-row-reverse justify-center items-center">
                <h2 className="alib mx-2 text-lg text-red-500">
                  {Number(
                    adult * (Math.floor(AdultTotalPriceG / 1000) * 1000) +
                      child * (Math.floor(ChildTotalPriceG / 1000) * 1000) +
                      infant *
                        (Math.floor((InfantTotalPriceG * 1.18943) / 1000) *
                          1000)
                  ) +
                    Number(
                      adult * (Math.floor(AdultTotalPriceR / 1000) * 1000) +
                        ...
                        infant *
                          (Math.floor((InfantTotalPriceR * 1.18943) / 1000) *
                            1000)
                    )}
                </h2>
                <h2 className="alib">ریال</h2>
