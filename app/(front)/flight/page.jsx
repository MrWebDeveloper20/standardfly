  ...
  return (
    <div className="w-full flex flex-col z-0">
      <div className="flex flex-col gap-5 h-fit z-10">
        <div className="topResult flex justify-center items-center bg-slate-100 w-full h-fit mt-2 rounded-lg py-4">
          <TopResult
        ...
        <div className="mainResult flex flex-row-reverse w-full h-fit">
