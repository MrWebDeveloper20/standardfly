...
function TrainDropDown(props) {
  ...
  const adultIncrease = (adultNum) => {
    if (adultNum < 6 - childNum - babyNum) {
      setAdultNum(adultNum + 1)
    } else {
      setAdultNum(6 - childNum - babyNum)
    }
  }
    ...
    switch (adultNum) {
      ...
      default:
        if (
          childNum < 6 &&
          childNum + babyNum < 6 &&
          adultNum + childNum + babyNum < 6
        ) {
          setChildNum(childNum + 1)
        } else {
          setChildNum(6 - adultNum - babyNum)
        }
        break
    }
  }
    ...
    switch (adultNum) {
      ...
      default:
        if (
          ...
          setBabyNum(6 - adultNum - childNum)
        }
        break
    }
  }
  ...
  return (
    <div ref={ref} className="menu relative">
      ...
      {isOpenDropdown && (
        <div className="dropdown absolute top-10 lg:-right-20 max-sm:-right-30 w-72 z-20 bg-gray-100 rounded-xl">
